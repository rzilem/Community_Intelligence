...
export const AssociationSettingsTab: React.FC<AssociationSettingsTabProps> = ({
  ...
  const addressSettingOptions = [
    { value: "association", label: "Association Address" },
  ...
  const thresholdTypeOptions = [
    ...
    { value: "months", label: "Months of Assessments" },
  ];
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <Select 
                      ...
                      onValueChange={(value) => handleSelectChange("ach_draft_amount", value)}
                    >
                      <SelectTrigger>
                        <SelectValue placeholder="Select draft amount option" />
                      </SelectTrigger>
                      <SelectContent>
                        {draftAmountOptions.map(option => (
                  ...
                  <div className="space-y-2">
                    ...
                    <Select 
                      ...
                      onValueChange={(value) => handleSelectChange("ach_include_charges", value)}
                    >
                      <SelectTrigger>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <Select 
                      ...
                      onValueChange={(value) => handleSelectChange("arc_model", value)}
                    >
                      <SelectTrigger>
                        <SelectValue placeholder="Select ARC model" />
                      </SelectTrigger>
                      <SelectContent>
                        {arcModelOptions.map(option => (
                          <SelectItem key={option.value} value={option.value}>
                            {option.label}
                          </SelectItem>
                        ))}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <Select 
                      ...
                      onValueChange={(value) => handleSelectChange("collections_active", value)}
                    >
                      <SelectTrigger>
                  ...
                  <div className="space-y-2">
                    ...
                    <Select 
                      ...
                      onValueChange={(value) => handleSelectChange("collections_model", value)}
                    >
                      <SelectTrigger>
                        <SelectValue placeholder="Select collections model" />
                      </SelectTrigger>
                      <SelectContent>
                        {collectionsModelOptions.map(option => (
                          <SelectItem key={option.value} value={option.value}>
                            {option.label}
                          </SelectItem>
                        ))}
                  ...
                  <div className="space-y-2">
                    ...
                    <Select 
                      ...
                      onValueChange={(value) => handleSelectChange("balance_threshold_type", value)}
                    >
                      <SelectTrigger>
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={handleChange}
                      placeholder="Balance threshold value"
                    />
                  </div>
                  <div className="space-y-2">
                    ...
                    <Select 
                      ...
                      onValueChange={(value) => handleSelectChange("lien_threshold_type", value)}
                    >
                      <SelectTrigger>
                        <SelectValue placeholder="Select threshold type" />
                      </SelectTrigger>
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={handleChange}
                      placeholder="Lien threshold value"
                    />
                  </div>
                  <div className="space-y-2">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <Select 
                      ...
                      onValueChange={(value) => handleSelectChange("association_address_setting", value)}
                    >
                      <SelectTrigger>
                        <SelectValue placeholder="Select address setting" />
                      </SelectTrigger>
                      <SelectContent>
                        {addressSettingOptions.map(option => (
                          <SelectItem key={option.value} value={option.value}>
                            {option.label}
                          </SelectItem>
                        ))}
                  ...
                  <div className="space-y-2">
                    ...
                    <Select 
                      ...
                      onValueChange={(value) => handleSelectChange("statement_format", value)}
                    >
                      <SelectTrigger>
                        <SelectValue placeholder="Select statement format" />
                      </SelectTrigger>
                      <SelectContent>
                        {statementFormatOptions.map(option => (
                          <SelectItem key={option.value} value={option.value}>
                            {option.label}
                          </SelectItem>
                        ))}
                  ...
                  <div className="space-y-2 col-span-2">
                    ...
                    <Input
                      ...
                      onChange={handleChange}
                      placeholder="Message to display on remittance coupons"
                    />
                  </div>
                  <div className="space-y-2 col-span-2">
                    ...
                    <Input
                      ...
                      onChange={handleChange}
                      placeholder="Message for utilities billing"
                    />
                  </div>
                  <div className="space-y-2 flex items-center">
                    <Switch
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <Select 
                      ...
                      onValueChange={(value) => handleSelectChange("association_time_zone", value)}
                    >
                      <SelectTrigger>
