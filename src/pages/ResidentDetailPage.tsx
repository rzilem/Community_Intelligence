...
const mockResident = {
  ...
  notes: [
    ...
    },
    {
      type: 'manual',
      author: 'Jane Smith',
      content: 'Resident called about maintenance request for kitchen sink',
      date: '2023-05-02'
    },
    {
      type: 'manual',
      author: 'John Doe',
      content: 'Resident mentioned they might renew for another year',
      date: '2023-04-10'
    }
  ]
};
...
const ResidentDetailPage: React.FC = () => {
  ...
  // In a real app, you would fetch resident data based on the id
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <div className="flex items-center text-sm text-muted-foreground">
                  ...
                  {`${resident.property} • ${resident.unit}`}
                </div>
              </div>
                ...
                <CardContent className="p-4 space-y-4">
                  ...
                  <div className="space-y-3">
                    <div>
                      ...
                      <p className="text-red-500 font-semibold ml-6">${resident.balance.toFixed(2)}</p>
                    </div>
                    <div>
                      <div className="flex items-center text-sm text-muted-foreground">
                        <Phone className="h-4 w-4 mr-2" />
                      ...
                      <div className="ml-6 text-sm space-y-1">
                        <p>Called: {resident.lastContact.called}</p>
                        <p>Office Visit: {resident.lastContact.visit}</p>
                        <p>Email: {resident.lastContact.email}</p>
                      </div>
                    </div>
                  </div>
                </CardContent>
          ...
          <TabsContent value="Summary">
            <Card>
              <CardContent className="p-6">
                <h2>Resident Summary Content</h2>
              ...
              <CardContent className="p-6">
                <div className="flex justify-between items-center mb-4">
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm">Internal notes and activity logs about this resident</p>
                  </div>
