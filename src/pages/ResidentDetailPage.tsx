...
// Import ResidentPreferencesForm
import { ResidentPreferencesForm } from '@/components/residents/ResidentPreferencesForm';
          ...
          <div className="space-y-4">
            ...
            {isEditing && isAdmin ? (
              ...
              <>
                ...
                />
                {/* Resident Preferences section for this resident */}
                {id && (
                  <div className="mt-6">
                    <ResidentPreferencesForm residentId={id} />
                  </div>
                )}
              </>
            )}
