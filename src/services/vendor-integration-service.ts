...
export const vendorIntegrationService = {
  ...
  async testAPIIntegration(integration: VendorIntegration): Promise<{ success: boolean; message: string }> {
    // Mock API test
    return { success: true, message: 'API connection successful' };
  },

  async testEmailIntegration(integration: VendorIntegration): Promise<{ success: boolean; message: string }> {
    // Mock email test
    return { success: true, message: 'Email configuration valid' };
  },

  async testPortalIntegration(integration: VendorIntegration): Promise<{ success: boolean; message: string }> {
    // Mock portal test
    return { success: true, message: 'Portal connection established' };
  },

  async testAccountingIntegration(integration: VendorIntegration): Promise<{ success: boolean; message: string }> {
    // Mock accounting test
    return { success: true, message: 'Accounting system connected' };
  },

  async testCalendarIntegration(integration: VendorIntegration): Promise<{ success: boolean; message: string }> {
    // Mock calendar test
