-- Accounting foundation migration (phase 1)
-- Safely extend schema and add new tables with RLS and indexes
...
BEGIN
  IF NOT EXISTS (
    ...
    EXECUTE $$CREATE POLICY "Users can access imports for their associations"
  ...
  IF NOT EXISTS (
    ...
    EXECUTE $$CREATE POLICY "Users can access bank transactions for their associations"
