...
import { Invoice } from "../../../src/types/invoice-types.ts";  // Updated path to match actual file location
      ...
      if (attachment) {
        ...
        try {
          ...
          if (typeof attachment.content === 'string') {
            ...
            const base64Content = attachment.content.replace(/^data:application\/pdf;base64,/, '');
            content = new Uint8Array(Array.from(atob(base64Content), c => c.charCodeAt(0)));
